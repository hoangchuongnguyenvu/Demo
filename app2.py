...
def main():
    ...
    if uploaded_file:
        ...
        # Nhập tọa độ của hình chữ nhật
        left = st.number_input("Tọa độ X của góc trái trên", min_value=0, max_value=image_np.shape[1], value=0)
        top = st.number_input("Tọa độ Y của góc trái trên", min_value=0, max_value=image_np.shape[0], value=0)
        right = st.number_input("Tọa độ X của góc phải dưới", min_value=0, max_value=image_np.shape[1], value=image_np.shape[1])
        bottom = st.number_input("Tọa độ Y của góc phải dưới", min_value=0, max_value=image_np.shape[0], value=image_np.shape[0])
